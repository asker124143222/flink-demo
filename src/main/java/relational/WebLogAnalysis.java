 ...
 * The tables referenced in the query can be generated using the {@link relational.WebLogDataGenerator} and
...
public class WebLogAnalysis {
    ...
    public static class AntiJoinVisits implements
            CoGroupFunction<Tuple3<Integer,String,Integer>, Tuple1<String>, Tuple3<Integer, String, Integer>>{
         ...
         */
        @Override
        public void coGroup(Iterable<Tuple3<Integer, String, Integer>> ranks, Iterable<Tuple1<String>> visits,
